    ...
    <div className="flex justify-center items-center  sm:px-2  lg:px-0 lg:pb-[190px] sm:pb-[126px] pb-[107px]">
      <div className="flex flex-col items-center">
        <div className="flex flex-col justify-center items-center">
          <p className="relative text-center font-[600] px-[50px] sm:px-0 lg:pb-[16px] sm:pb-[0px] pb-[11px] text-[20px] leading-[24px] sm:text-[24px] sm:leading-[28.8px] lg:text-[40px] lg:leading-[48px]">
            <span className="billyOhioText text-[#006B66] absolute font-[400] text-[24px] leading-[28.8px] lg:text-[38px] lg:leading-[45.6px] sm:text-[24px] sm:leading-[28.8px] sm:px-0 lg:-left-12  sm:-left-10 left-8 lg:-top-9 sm:-top-7 -top-6">
              Empower
            </span>
...
const Box1: React.FC = () => {
  return (
    <div
      ...
      className="rounded-[20px] overflow-hidden sm:flex mx-[20px] lg:mx-[223px] 3xl:mx-[160px] flex-row-reverse items-center sm:py-[50px]  lg:py-0  lg:mb-[20px] 3xl:mb-[24px] mb-[21px] sm:rounded-[10px] lg:rounded-[13.89px] 3xl:rounded-[20px] "
    >
      <div className="text-center sm:text-start  pt-8 sm:w-1/2 lg:w-[60%] sm:px-8 lg:px-0">
        ...
        <h5 className="text-[16px] text-[#F5F3ED] leading-[19.2px]  font-[600] sm:text-[16px] lg:text-[24px] lg:leading-[28.8px] 3xl:text-[40px] ">
          Say Goodbye to Service Delays
        </h5>
        <p className="text-[#F5F3ED] font-[500] sm:font-[400] leading-[15px]  text-center sm:text-start text-[10px] sm:text-[11px] 3xl:text-[16px] lg:text-[14px] mt-[24px] pl-[25px] pr-[29px] sm:pr-[80px] sm:pl-0 sm:mt-[5px] lg:mt-[14.47px] lg:pr-[49.29px] sm:leading-[19.5px] lg:leading-[21px] 3xl:leading-[28px] 3xl:pr-[149px]">
      ...
      <div className="pl-[27px] pr-[37px] sm:w-1/2 lg:pl-[140px] 3xl:pl-[149px] sm:pl-[64px] lg:pt-[105px] lg:pb-[74.52px] lg:flex lg:justify-between ">
...
const Box2: React.FC = () => {
  ...
  return (
    <div
      className="flex justify-center items-center sm:w-[98vw] lg:w-auto lg:mx-[223px] 3xl:mx-[160px] px-[54px] sm:pl-[118px] 3xl:pl-[405px] sm:pr-[132px] lg:pl-[247px] lg:pr-[227px] 3xl:pr-[399px] pt-[75px] pb-[74px] sm:py-[50px]   lg:pt-[48px] lg:pb-[52px] mx-[20px]  3xl:pt-[110px] 3xl:pb-[69px] lg:mb-[20px] 3xl:mb-[24px] mb-[21px] custom-height saurabh-bug  rounded-[20px] sm:rounded-[10px] lg:rounded-[13.89px] 3xl:rounded-[20px]"
      style={{
        backgroundImage: `url(${
    ...
    >
      ...
      <div className="bg-[#F5F3ED] rounded-[10px] lg:rounded-[20.84px]">
        <p className="billyOhioText text-[#F58121] text-[16px] sm:text-[18px] lg:text-[24px] 3xl:text-[32px]  font-[400] leading-[19.2px] sm:leading-[21.6px] lg:leading-[36px] 3xl:leading-[48px] text-center pt-[32px] sm:pt-[66px]  lg:pt-[60px] 3xl:pt-[141px]">z
          Master your Operation
        </p>
        <h5 className="text-[16px] lg:text-[24px] lg:leading-[28.8px] sm:leading-[19.2px] 3xl:text-[40px] font-[600] leading-[19.2px] 3xl:leading-[48px] text-center pl-[31px] sm:pl-[68px] lg:pl-[58px] 3xl:pl-[123px] pr-[30px] sm:pr-[58px] lg:pr-[79px] 3xl:pr-[112px]">
          Less ‘just a second’ <br />
          More done in just a few seconds
        </h5>
        <p className="text-[10px] sm:text-[11px]  lg:text-[14px] lg:leading-[21px] 3xl:text-[18px] font-[500] lg:font-[400] leading-[15px] sm:leading-[16.5px] 3xl:leading-[27px] text-center mt-[23px] sm:mt-[10px] lg:mt-[14.03px] pl-[11px] sm:pl-[51px] pr-[10px] sm:pr-[57px]">
        ...
        <div className="flex justify-center mt-[23px] sm:mt-[30px] lg:mt-[20.66px] pb-[50.03px] sm:pb-[58.3px] lg:pb-[95.75px] 3xl:pb-[161px] ">
...
const Box3: React.FC = () => {
  return (
    <div
      className="flex flex-col lg:flex-row md:flex-row sm:flex-row mx-[22px]  bg-cover bg-center rounded-[20px]   sm:rounded-[10px]  lg:min-w-0 lg:mx-[223px] 3xl:mx-[160px] items-center justify-center lg:justify-between pt-[34px] 3xl:p-0 pb-[10px] sm:pt-[88px] lg:pt-[0px]  lg:rounded-[13.89px] 3xl:rounded-[30px] overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="text-start sm:w-2/3  lg:pl-[129px] sm:pl-[62px] sm:pr-[68px] lg:pt-[126px] ">
        ...
        <div className="flex justify-center w-full sm:justify-start sm:pt-[30px] lg:pt-[90.6px] 3xl:pt-[20px] sm:pb-[88px] lg:pb-[43px]">
          <button className="bg-[#F5F3ED]  text-[#00413E] font-[500] justify-center border-2 sm:border border-[#00413E] text-center text-[12px] sm:text-[10px] 3xl:text-[20px] 3xl:leading-[30px] sm:text-base  shadow-[4px_4px_0_rgba(0,0,0,1)] py-[7px] sm:py-[10px] sm:px-[21px] pl-[25px] pr-[25px] pt-[7px] pb-[8px] leading-[18px] rounded-[10px] flex items-center active:bg-[#E2E0D9] active:shadow-[4px_4px_0_rgba(0,0,0,1)] hover:shadow-none">
            Learn More
          </button>
        </div>
      </div>
      ...
      <div className="w-full  lg:w-[50%]  lg:flex lg:justify-center sm:self-start md:w-[50%] pl-[39px] pr-[47px] sm:pr-[52.8px]  sm:w-[50%] sm:items-center sm:mx-auto  sm:px-4  3xl:pr-[89px] lg:pt-[125px] 3xl:py-[125px]">
        <Image
          src={boxperfect3}
          width={1000}
          alt="box3"
