...
const SectionHeader: React.FC<{ title: string; description: string }> = ({
  ...
  <div className="sm:flex   sm:gap-[27px]  lg:pb-[64px] 3xl:pb-[96] sm:pb-[0px] ">
    <div className="relative w-full text-[#000000] sm:w-[50%] lg:w-[55%]  text-[20px] leading-[24px] text-center sm:text-start sm:text-[24px] lg:text-[48px] font-[600] sm:leading-[28.8px] lg:pl-[151px] 3xl:pl-0 lg:leading-[57.6px] pl-[45px] pr-[38px] sm:px-0">
      {title}
    ...
    <p className="  w-full text-[#000000] text-center sm:text-start sm:w-[50%] sm:text-[11px] sm:leading-[16.5px] lg:w-[45%] lg:text-[20px] lg:leading-[30px] font-[500] text-[13px] leading-[19.5px] mt-[11px] pl-[20px] pr-[18px]  sm:py-0 sm:px-0 lg:text-base lg:pr-[120px] 3xl:pr-0">
      {description}
    </p>
  </div>
);
...
const EfficiencyCard: React.FC<EfficiencyCardProps> = ({
  ...
  <div className="sm:border-[1.5px] lg:border-[2.32px] lg:rounded-[15.47px] border-2  border-[#006B66] rounded-[20px] sm:rounded-[8px] w-fit mx-auto max-w-[491px] lg:max-w-screen-3xl  px-[20px] pt-[20px] pb-[40px] sm:px-[14px] lg:px-[15.48px] 3xl:px-[20px] lg:pt-[15.48px] 3xl:pt-[20px] sm:pt-[14px] sm:pb-[20px]   sm:my-0 lg:shadow-[0px_4px_14px_0px_rgba(0,107,102,0.25)]">
    ...
    />
    <h5 className="text-[#000000] text-[16px] leading-[20.8px] font-[600] sm:text-[12px] sm:leading-[15.6px] sm:py-3 lg:text-[24px] text-center lg:leading-[31.2px] lg:py-6 3xl:pt-[34px] 3xl:pb-[16px] pt-[25px] pb-[12px]">
      {heading}
    </h5>
