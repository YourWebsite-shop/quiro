  ...
  return (
    <div className="sm:mr-[69px] sm:ml-[72px] ml-[37px] mr-[30px] mt-[80px] sm:mt-[96px] lg:mx-[120px] 3xl:mx-[228px]">
      <div className="relative text-center">
        <p className="billyOhioText text-start text-[#006b66] text-[16px] font-[400] leading-[24px]  sm:text-[18px] sm:leading-[21.6px] lg:text-[40px] lg:leading-[48px] sm:translate-x-16 lg:translate-x-[250px] 2xl:translate-x-[22%] 3xl:translate-x-[200px] ">
          Boosters
        </p>
