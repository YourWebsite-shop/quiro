...
const Hero: React.FC = () => {
  return (
    <div className="  overflow-hidden mx-[20px] sm:mx-[46px] flex items-center justify-center relative lg:py-24  lg:px-10   bg-[#F5F3ED] lg:mx-14">
                    <Image
                      src={heroPC}
                      alt="heropc"
                      width={1000}
                    ...
                    />
                    <div className="z-10 pl-[20px] sm:pl-[37px] sm:pr-[33px] pr-[11px] py-[30px] sm:pt-[51px] sm:pb-[74px]">
                      ...
                      <p className="text-white text-[13px] sm:text-[11px] py-2 sm:pt-6 leading-[19.5px] lg:text-[18px] lg:leading-[36px]">
