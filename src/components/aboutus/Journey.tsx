...
const Journey: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center border-2 border-[#006B66] rounded-[15px] lg:gap-40 m-4 sm:m-6 lg:m-10 p-6 sm:p-8 lg:p-12">
      <div className="flex flex-col justify-center  items-center lg:items-start lg:w-1/2">
        ...
        <p className="text-[13px] font-[400] leading-[19.5px] text-[#000000] md:hidden lg:hidden sm:block text-center py-8">
        ...
        <p className="text-[13px] lg:text-[20px] font-[500] leading-[19.5px] lg:leading-[30px] text-[#000000] md:block lg:block sm:hidden text-center lg:text-start py-8">
