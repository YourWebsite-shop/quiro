  ...
  return (
    <div className="flex flex-col justify-center items-center p-5 sm:p-10 lg:p-20 mt-10">
      <div className="w-full">
        <p className="billyOhioText text-[#006B66] text-[24px] text-center -translate-x-14 translate-y-1">Revolutionize</p>
        <h1 className="relative text-[#000000] text-[20px] sm:text-[32px] lg:text-[80px] font-semibold leading-[24px] sm:leading-[38px] lg:leading-[96px] mb-8 flex items-center justify-center sm:justify-start">
      ...
      <div className="flex justify-end w-full">
        <div className="flex items-center sm:items-end justify-center sm:justify-end  pr-2">
          <p className="text-[#000000] text-[20px] sm:text-[18px] leading-[32px] font-light sm:leading-[29px] sm:text-end text-center block lg:hidden sm:w-[45%] md:w-[50%]">
